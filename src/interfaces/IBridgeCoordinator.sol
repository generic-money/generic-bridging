 ...
 * @notice Interface for coordinating cross-chain bridge operations for share tokens
 * @dev Manages routing between different bridge adapters and handles inbound/outbound bridging
 */
interface IBridgeCoordinator {
    /**
     * @notice Settles an inbound bridge operation by releasing (unlocking or minting) shares to the recipient
